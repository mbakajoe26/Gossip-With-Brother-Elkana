        ...
        {userId ? (
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <SignInButton mode="modal" strategy="oauth_twitter">
                <button className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-[#1DA1F2] text-white gap-2 hover:bg-[#1a8cd8] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5">
